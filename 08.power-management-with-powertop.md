...
請使用 **Tab**, **Shift + Tab** 或**方向鍵 ←, →** 切換至 **Tunables** 分頁 [^1]，並使用 **↑, ↓** 上下移動，於欲調校的項目按下 **Enter** 進行調校，當所有狀態顯示為 Good 後即可按下 **q** 離開。
...
[^1]: 感謝 [theJian](https://github.com/theJian) 回報，powertop v2.5 之後切換 Tunables 分頁的功能鍵已從**方向鍵 ←, →** 改為 **Tab** 和 **Shift + Tab**。
