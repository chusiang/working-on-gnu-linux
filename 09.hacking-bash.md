...
vi: 使用 H, J, K, L 取代左、下、上、上移動的純文字編輯器。

- [[完全用 GNU/Linux 工作] 11. Hacking Vim](11.hacking-vim.md)
...
檢視 (cat) 檔案，並將結果丟給管線 (pipe) 後的程式處理 (xlip: 複製內容至剪貼簿)。
...
如想取得凍仁完整的 bash 環境設定，請參考 [凍仁的 GitHub](https://github.com/chusiang/tuxENV)。
